#!/usr/bin/env bash
#
# Compiles the mod into SoundBlocks.dll, using Besiege's OWN C# compiler rather
...
#
# Mod.xml loads SoundBlocks.dll directly, so the mod ships as a prebuilt
...
mkdir -p "$BUILD_DIR"
TMP_OUT="$BUILD_DIR/SoundBlocks.$$.dll"
